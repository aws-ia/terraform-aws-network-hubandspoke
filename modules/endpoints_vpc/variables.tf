...
# --- modules/endpoints_vpc/variables.tf ---
...
variable "cidr_block" {
  type        = string
  description = "Endpoints VPC CIDR block."
}
...
variable "enable_dns" {
  type        = bool
  description = "Boolean indicating if this VPC should have subnets for any DNS forwarder."
}
